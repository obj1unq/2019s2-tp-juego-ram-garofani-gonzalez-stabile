...
object areasProhibidas {
	method levelTres() = [
							...
							game.at(10,1),game.at(10,2),game.at(10,3),game.at(10,12),
							game.at(9,5),game.at(9,7),game.at(9,8),game.at(9,9),game.at(9,12),	
							game.at(8,1),game.at(8,5),game.at(8,7),game.at(8,12),
							game.at(7,1),game.at(7,5),game.at(7,7),game.at(7,12),
